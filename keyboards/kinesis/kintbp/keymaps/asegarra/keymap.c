...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //   KC_CAPS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,  KC_F8,    KC_F9,  KC_F10,  KC_F11,   KC_F12,   KC_PSCR,  KC_SCRL,  KC_PAUS,  MO(1),    QK_BOOT,
  //   KC_EQL,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,                                                            KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,
  //   KC_TAB,   KC_Y,     KC_P,     KC_O,     KC_U,     KC_J,                                                            KC_K,     KC_D,     KC_L,     KC_C,     KC_W,     KC_BSLS,
  //   CW_TOGG,  KC_I,     KC_N,     KC_E,     KC_A,     KC_SCLN,                                                         KC_M,     KC_H,     KC_T,     KC_S,     KC_R,     KC_SLSH,
  //   OS_LSFT,  KC_Q,     KC_Z,     KC_COMM,  KC_DOT,   KC_QUOT,                                                         KC_B,     KC_F,     KC_G,     KC_V,     KC_X,     OS_RSFT,
  //             KC_GRV,   KC_DEL,   KC_LEFT,  KC_RGHT,                                                                             KC_DOWN,  KC_UP,    KC_LBRC,  KC_RBRC,
  //                                                     TAB_LCTL, KC_LALT,                                     KC_RALT,  ESC_RCTL,
  //                                                               KC_HOME,                                     KC_PGUP,
  //                                           KC_BSPC,  KC_LGUI,  KC_END,                                      KC_PGDN,  KC_ENTER, KC_SPC
